...
public class SystemController {
    ...
    void createNewBook(ActionEvent event) {
    	...
    	System.out.printf("Add book with: ISBN: %s, Title: %s, Authors: %s, Max Checkout: %s, num of copies: %s \n",
    			fieldNewBookISBN.getText(), fieldNewBookTitle.getText(), fieldNewBookAuthors.getText(), choiceNewBookMaxCheckout.getValue(), 
    			fieldNewBookNumCopies.getText());
    }
